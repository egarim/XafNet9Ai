...
namespace XafSmartEditors.Razor.AiExtChatClientFunctions
{
    ...
    public class AiExtChatViewFunctions : IXafEntityObject/*, IObjectSpaceLink*/, INotifyPropertyChanged
    {
        ...
        IChatHistoryFunctions chatHistory;
        public IChatHistoryFunctions ChatHistory
        {
            get => chatHistory;
            set
            {
